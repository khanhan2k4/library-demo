...
<body>
    <!--  -->
    <h1 style="text-align:center;"> <a href="javascript:void(0);" class="link" onclick="redirectToPreviousPage()"><<<</a>  Biểu đồ cột hiển thị số lượng sách theo từng thể loại<a href="javascript:void(0);" class="link" onclick="redirectToPage()">>>></a></h1>
    <!--  -->
...
function redirectToPreviousPage() {
        ...
        function redirectToPage() {
            window.location.href = 'thongkeslsach_tron.php'; // >>> chuyển đi
        }
