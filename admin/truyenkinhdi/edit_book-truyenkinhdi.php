...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT image_path FROM truyenkinhdi WHERE id='$id'";
    ...
    $sql = "UPDATE truyenkinhdi SET title='$title', author='$author', image_path='$image_path', tomtat='$tomtat', theloai='$theloai', publisher='$publisher', release_date='$release_date', Day='$Day', so_luong='$so_luong' WHERE id='$id'";

    if ($conn->query($sql) === TRUE) {
        echo "Cập nhật sách thành công!";
        header("Location: dulieutrangchu-truyenkinhdi.php");
        exit();
    } else {
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM truyenkinhdi WHERE id='$id'";
    $result = $conn->query($sql);
...
<body>
    <div class="container">
        <form action="edit_book-truyenkinhdi.php" method="post" enctype="multipart/form-data">
