...
//sửa lại thành bảng truyentranh
    $sql = "INSERT INTO truyenkinhdi (title, author, image_path,tomtat,theloai,publisher, release_date,Day,so_luong) VALUES ('$title', '$author', '$image_path', ' $tomtat','$theloai','$publisher','$release_date', '$Day','$so_luong')";
...
<body>
    <div class="container">
        <!-- thêm thư mục sachvuaramat/  -->
        <form action="add_book-truyenkinhdi.php" method="post">
            <h2>Thêm sách mới</h2>
