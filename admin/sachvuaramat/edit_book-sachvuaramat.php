...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE books SET title='$title', author='$author', image_path='$image_path', tomtat='$tomtat', theloai='$theloai', publisher='$publisher', release_date='$release_date', Day='$Day', so_luong='$so_luong' WHERE id='$id'";
...
<head>
    ...
    <!-- thêm ../css/edit_books.css này vào  -->
    <link rel="stylesheet" href="../css/edit_books.css">
</head>
<body>
    <div class="container">
        <form action="edit_book-sachvuaramat.php" method="post" enctype="multipart/form-data">
