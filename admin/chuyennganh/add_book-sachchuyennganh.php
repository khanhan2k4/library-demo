...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO sachchuyennganh (title, author, image_path,tomtat,theloai,publisher, release_date,Day,so_luong) VALUES ('$title', '$author', '$image_path', ' $tomtat','$theloai','$publisher','$release_date', '$Day','$so_luong')";
...
<body>
    <div class="container">
        <form action="add_book-sachchuyennganh.php" method="post">
            <h2>Thêm sách mới</h2>
