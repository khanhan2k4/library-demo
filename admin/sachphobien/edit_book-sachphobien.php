...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT image_path FROM popular_books WHERE id='$id'";
    ...
    $sql = "UPDATE popular_books SET title='$title', author='$author', image_path='$image_path', tomtat='$tomtat', theloai='$theloai', publisher='$publisher', release_date='$release_date', Day='$Day', so_luong='$so_luong' WHERE id='$id'";
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM popular_books WHERE id='$id'";
    $result = $conn->query($sql);
...
<body>
    <div class="container">
        <form action="edit_book-sachphobien.php" method="post" enctype="multipart/form-data">
